...
<div class="card" id="company-setting-sidenav">
    ...
    <div class="card-body p-3 pb-0">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="form-group">
                    {{ Form::label('sip_server_domain', __('SIP Server Domain'), ['class' => 'form-label']) }}
                    {{ Form::text('sip_server_domain', !empty($settings['sip_server_domain']) ? $settings['sip_server_domain'] : null, ['class' => 'form-control ', 'placeholder' => __('Enter SIP Server Domain')]) }}
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="form-group">
