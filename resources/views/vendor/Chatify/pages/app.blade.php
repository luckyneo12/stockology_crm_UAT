                    ...
                    <div class="card-body p-0">
                        <div class="messenger">
                                        ...
                                        <div class="header-user-info">
                                            ...
                                            <div class="user-avatar-wrapper">
                                                @if(!empty(Auth::user()->avatar))
                                                    <div class="avatar av-s header-avatar" style="background-image: url('{{ get_file(Auth::user()->avatar) }}');"></div>
                                                @else
                                                    <div class="avatar av-s header-avatar" style="background-image: url('{{ get_file('uploads/users-avatar/avatar.png') }}');"></div>
                                                @endif
                                                <div class="user-details">
                                                    <a href="#" class="user-name">{{ config('chatify.name') }}</a>
                                                    <span class="user-status">{{__('Online')}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- header buttons --}}
                            ...
                            <div class="messenger-infoView app-scroll">
                                {{-- nav actions --}}
                                <nav>
                                    <a href="#" class="close-info"><i class="fas fa-times"></i></a>
                                </nav>
