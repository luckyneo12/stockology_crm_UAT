                            ...
                            <div class="bottom-icons d-flex flex-wrap align-items-center justify-content-between">
                                @if ($user->is_disable == 1)
                                    <div class="edit-btn-wrp d-flex flex-wrap align-items-center">
                                        <a href="{{ route('users.status', $user->id) }}" class="btn btn-sm border me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Click to Activate') }}">
                                            <i class="ti ti-lock-off text-danger"></i>
                                        </a>
                                        <span class="badge bg-danger p-2 px-3 ms-2">{{ __('Inactive') }}</span>
                                    </div>
                                @else
                                    <div class="edit-btn-wrp d-flex flex-wrap align-items-center">
                                         <a href="{{ route('users.status', $user->id) }}" class="btn btn-sm border me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Click to Deactivate') }}">
