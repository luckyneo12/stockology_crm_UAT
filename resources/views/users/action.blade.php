...
@if ($user->is_disable == 1 || Auth::user()->type == 'super admin')
    ...
    @if(!empty($user->mobile_no))
        <div class="action-btn me-2">
            <a href="{{ sip_link($user->mobile_no) }}" class="btn btn-sm d-inline-flex align-items-center bg-primary" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Call') }}">
                <span class="text-white"> <i class="ti ti-phone-call"></i></span>
            </a>
        </div>
    @endif
