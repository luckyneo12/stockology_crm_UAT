                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        <img src="{{!empty($userDetail->avatar) ? get_file($userDetail->avatar) : get_file('uploads/users-avatar/avatar.png')}}" id="myAvatar"  alt="user-image" class="img-thumbnail m-2 w-25" style="height:120px">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            @if(!empty($userDetail->mobile_no))
                                                <a href="{{ sip_link($userDetail->mobile_no) }}" class="btn btn-primary" data-bs-toggle="tooltip" title="{{ __('Call') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('bio') is-invalid @enderror" name="bio" id="bio" placeholder="{{ __('Enter Your Bio') }}" rows="3">{{ $userDetail->bio }}</textarea>
                                        @error('bio')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
