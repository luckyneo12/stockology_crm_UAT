                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            <img src="{{!empty($userDetail->avatar) ? get_file($userDetail->avatar) : get_file('uploads/users-avatar/avatar.png')}}"
                                                id="myAvatar" alt="user-image" class="img-thumbnail m-2 w-25"
                                                style="height:120px">
                                            <div class="choose-files mt-3">
                                                <label for="avatar">
                                                    ...
                                                    <input type="file" accept="image/png, image/gif, image/jpeg,  image/jpg"
                                                        class="form-control" name="profile" id="avatar"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control @error('mobile_no') is-invalid @enderror"
                                                    name="mobile_no" type="text" id="mobile_no"
                                                    placeholder="{{ __('Enter Your Mobile No') }}"
                                                    value="{{ $userDetail->mobile_no }}">
                                                @if(!empty($userDetail->mobile_no))
                                                    <a href="{{ sip_link($userDetail->mobile_no) }}" class="btn btn-primary"
                                                        data-bs-toggle="tooltip" title="{{ __('Call') }}">
                                    ...
                                    <input class="form-control @error('extension') is-invalid @enderror" name="extension"
                                        type="text" id="extension"
                                        placeholder="{{ __('Enter Your Extension (e.g. 3025)') }}"
                                        value="{{ $userDetail->extension }}" autocomplete="off">
                                    @error('extension')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('bio') is-invalid @enderror" name="bio" id="bio"
                                        placeholder="{{ __('Enter Your Bio') }}" rows="3">{{ $userDetail->bio }}</textarea>
                                    @error('bio')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
