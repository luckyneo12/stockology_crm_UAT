                ...
                <div class="card">
                    <div class="card-body pt-1">
                        ...
                        <div class="mt-2">
                            ...
                            {{ Form::text('allowed_login_ips', null, ['class' => 'form-control', 'placeholder' => __('Enter IP addresses separated by comma (e.g. 192.168.1.1, 203.0.113.5)')]) }}
                                                                    ...
                                                                    @foreach ($permissions as $key => $prermission)
                                                                        ...
                                                                        @if ($list == $check)
                                                                            <div class="col-xl-3 col-sm-6 form-check mb-2">
                                                                                {{ Form::checkbox('permissions[]', $prermission->id, false, ['class' => 'form-check-input pointer checkbox-' . strtolower($module), 'id' => 'permission_' . $key . '_' . $prermission->id]) }}
