...
.user-profile-sidebar {
    ...
    display: flex;
    flex-direction: column;
    box-shadow: -4px 0 15px rgba(0,0,0,0.05); /* Add shadow for better separation */
}
                ...
                <div class="messenger-container">
                    ...
                    <div class="conversations-panel">
                        <div class="conversations-header d-flex justify-content-between align-items-center">
                            ...
                            @permission('messenger group create')
                                <button class="btn btn-sm btn-primary-light" data-bs-toggle="modal" data-bs-target="#createGroupModal" title="{{ __('Create Group Chat') }}">
                        ...
                        <div class="px-3 pb-3">
                            <div class="message-input-container">
                                <input type="text" id="messenger-search" class="message-input" placeholder="{{ __('Search conversations...') }}" style="padding: 8px 12px; height: auto;">
                    ...
                    <div class="chat-panel">
                        ...
                        <div id="user-profile-sidebar" class="user-profile-sidebar">
                            ...
                            <div class="body">
                                <div class="text-center mb-4">
                                    <img id="sidebar-avatar" src="" alt="" class="rounded-circle mb-2" style="width: 80px; height: 80px; object-fit: cover;">
                                 ...
                                 <div id="group-admin-options" style="display: none;" class="mb-4">
                                    ...
                                    <div class="d-flex gap-2 mb-3">
                                        <button class="btn btn-sm btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#addMemberModal">
                                            <i class="ti ti-user-plus me-1"></i> {{ __('Add Member') }}
                                        </button>
                                        <button class="btn btn-sm btn-outline-secondary w-100" data-bs-toggle="modal" data-bs-target="#groupSettingsModal">
                        ...
                        <div id="message-input-container" class="chat-input" style="display: none;">
                            <div id="image-preview" class="image-preview" style="display: none; padding: 10px; background: #f0f2f5; border-top: 1px solid #e4e6eb;">
                                <div style="position: relative; display: inline-block;">
                                    <img src="" alt="Preview" style="max-height: 100px; border-radius: 8px; border: 1px solid #ddd;">
                                    <button onclick="cancelImage()" style="position: absolute; top: -8px; right: -8px; background: #fff; border-radius: 50%; border: 1px solid #ddd; width: 20px; height: 20px; line-height: 18px; text-align: center; cursor: pointer; color: #666;">&times;</button>
                                </div>
                            </div>
                            <div class="message-input-container">
                                <button id="file-btn" class="file-btn" style="border: none; background: none; color: #6c757d; padding: 0 10px; cursor: pointer;">
                                    <i class="ti ti-paperclip"></i>
                                </button>
                                <input type="file" id="message-file" style="display: none;" accept="image/*,application/pdf,text/csv,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                                <input type="text" id="message-input" class="message-input" placeholder="{{ __('Type a message...') }}">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <hr class="my-2">
                            <div id="addMembersList" style="max-height: 250px; overflow-y: auto; padding: 10px; border: 1px solid #eee; border-radius: 8px;">
                                <div class="text-center py-3">
                                    <div class="spinner-border spinner-border-sm text-primary" role="status"></div>
                                    <p class="small mt-2 mb-0">{{ __('Loading users...') }}</p>
                                </div>
...
$(document).ready(function() {
    ...
    function startToastNotifications() {
        ...
        // Start checking for new messages every 8 seconds
    ...
    function startMessagePolling(id, type = 'user') {
        ...
        }, 3000); // 3 seconds is enough for most cases
    }
