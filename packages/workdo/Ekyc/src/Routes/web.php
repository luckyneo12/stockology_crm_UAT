...
Route::prefix('ekyc')->name('ekyc.')->group(function () {
    ...
    Route::middleware([\Workdo\Ekyc\Http\Middleware\CheckEkycMaintenance::class])->group(function () {
            ...
            Route::get('/reverse-geocode', [\Workdo\Ekyc\Http\Controllers\EkycFormController::class , 'reverseGeocode'])->name('form.reverse-geocode');
            ...
            Route::post('/init-digio-selfie', [\Workdo\Ekyc\Http\Controllers\EkycFormController::class , 'initializeSelfieSession'])->name('form.init-digio-selfie');
            Route::post('/confirm-selfie', [\Workdo\Ekyc\Http\Controllers\EkycFormController::class , 'confirmSelfie'])->name('form.confirm-selfie');
            Route::post('/init-esign', [\Workdo\Ekyc\Http\Controllers\EkycFormController::class , 'initializeEsign'])->name('form.init-esign');
            Route::post('/confirm-esign', [\Workdo\Ekyc\Http\Controllers\EkycFormController::class , 'confirmEsign'])->name('form.confirm-esign');
            Route::get('/view-esign/{template_id}', [\Workdo\Ekyc\Http\Controllers\EkycFormController::class , 'viewEsignPdf'])->name('form.view-esign');
...
Route::group(['middleware' => ['web', 'auth']], function () {
    ...
    Route::get('ekyc/pdf-editor', [EkycController::class , 'pdfEditor'])->name('ekyc.pdf-editor');
