...
@if($lead->phone)
    <div class="action-btn me-2">
        <a href="javascript:void(0)" class="mx-3 btn btn-sm align-items-center bg-success click-to-call"
            data-phone="{{ $lead->phone }}" data-bs-toggle="tooltip" data-bs-placement="top"
...
@if($lead->is_active)
    <div class="action-btn me-2">
        <a href="{{route('leads.show', $lead->id)}}" class="mx-3 btn btn-sm align-items-center bg-warning"
            data-toggle="tooltip" data-original-title="{{__('View')}}" data-bs-toggle="tooltip" data-bs-placement="top"
...
<div class="action-btn me-2">
    ...
    <a href="#!" class="mx-3 btn btn-sm align-items-center show_confirm bg-danger" data-bs-toggle="tooltip"
        data-bs-placement="top" title="{{__('Delete')}}" data-confirm="{{ __('Are You Sure?') }}"
