...
@if(!empty($reminder))
{{ Form::model($reminder, array('route' => array('leads.reminders.update', $lead->id, $reminder->id), 'method' => 'PUT','class'=>'needs-validation','novalidate')) }}
@else
{{ Form::open(array('route' => ['leads.reminders.store',$lead->id],'class'=>'needs-validation','novalidate')) }}
@endif
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-6 form-group">
            {{ Form::label('remind_at', __('Remind At'),['class'=>'form-label']) }}<x-required></x-required>
