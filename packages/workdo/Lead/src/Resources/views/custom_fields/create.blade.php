                ...
                <div class="rounded-3 border mb-3 p-3 bg-white shadow-sm" style="max-height: 280px; overflow-y: auto;">
                    @foreach($pipelines as $pipeline)
                        ...
                        @foreach($pipeline->leadStages as $stage)
                            @php
                                $currentConfig = 'visible'; // default for create custom field
                            @endphp
                            <div class="d-flex align-items-center justify-content-between py-2 border-bottom border-light" style="border-bottom-style: dashed !important; min-height: 48px;">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-shrink-0">
                                    ...
                                    <div class="min-value-col d-none" style="width: 80px; flex-shrink: 0;">
                                        <input type="number" step="any" name="stage_min_values[{{ $stage->id }}]" class="form-control" style="width: 100%; height: 30px; border-radius: 20px; font-size: 0.72rem; text-align: center; border: 1px solid #cbd5e1; padding: 2px 5px;" placeholder="{{ __('Min') }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
