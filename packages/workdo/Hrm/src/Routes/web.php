...
use Workdo\Hrm\Http\Controllers\OrgChartController;
...
Route::group(['middleware' => ['web', 'auth', 'verified','PlanModuleCheck:Hrm']], function () {
    Route::prefix('hrm')->group(function () {
        ...
        Route::post('/org-chart/update-hierarchy', [OrgChartController::class, 'updateHierarchy'])->name('hrm.org_chart.update_hierarchy');
        Route::post('/org-chart/remove-from-hierarchy', [OrgChartController::class, 'removeFromHierarchy'])->name('hrm.org_chart.remove_from_hierarchy');
    });
    ...
    Route::get('department/{department}/add-employee', [DepartmentController::class, 'addEmployee'])->name('department.add_employee');
    Route::post('department/{department}/store-employee', [DepartmentController::class, 'storeEmployee'])->name('department.store_employee');
    Route::delete('department/{department}/remove-employee/{employee}', [DepartmentController::class, 'removeEmployee'])->name('department.remove_employee');
