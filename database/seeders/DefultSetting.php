    ...
    public function run()
    {
        ...
        // admin settings
            ...
            $admin_setting = [
                ...
                "title_text" => !empty(env('APP_NAME')) ? env('APP_NAME') : 'stockology_CRM',
                "footer_text" => "Copyright © ".(!empty(env('APP_NAME')) ? env('APP_NAME') : 'stockology_CRM'),
                "landing_page" => "on",
                "site_rtl" => "off",
                "cust_darklayout" => "off",
                "site_transparent" => "on",
                ...
                "meta_title" => "stockology_CRM",
                "meta_keywords" => "stockology_CRM, SaaS solution, CRM, Business productivity",
                "meta_description" => "Discover the efficiency of stockology_CRM. Streamline project management, organize tasks, collaborate seamlessly, and track progress effortlessly.",
