    ...
    <div class="row align-items-center m-1">
        <div class="col-auto pe-0">
            @permission('ekyc manage')
                <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create')}}" data-ajax-popup="true" data-size="md" data-title="{{__('Create Stage')}}" data-url="{{route('ekyc.stages.create')}}"><i class="ti ti-plus text-white"></i></a>
            @endpermission
        </div>
    </div>
@endsection
