                                ...
                                @if (\Auth::user()->type != 'employee')
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                {{ Form::label('parent_id', __('Reporting To'), ['class' => 'form-label']) }}
                                                {{ Form::select('parent_id', $managers, isset($employee->parent_id) ? $employee->parent_id : null, ['class' => 'form-control', 'placeholder' => __('Direct Report to Admin (Root)')]) }}
                                            </div>
                                            <div class="form-group col-md-6">
